          ...
          <div className={classes.div4}>
            <div className={classes.div5}>
              <div className={classes.div51}>
                ...
                <p data-testid='movie-title' className={classes.inline}> {arr.title}</p> · <p className={classes.inline} data-testid='movie-release-date'>{arr.release_date.split('').map((data,index)=>{if(index<4){return data}}).join('')}</p> · <p style={{display:'inline'}}>PG-13</p> · <p data-testid='movie-runtime' className={classes.inline}>{arr.runtime}m</p>
                </div>{" "}
